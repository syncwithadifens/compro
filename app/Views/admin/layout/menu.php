...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="<?php echo base_url() ?>/admin/dasbor" class="brand-link">
    <div class="user-panel bg-white p-2">
      <img src="<?php echo base_url('assets/upload/image/' . $site['icon']) ?>" alt="AdminLTE Logo" class="img-circle" style="opacity: .8">
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      ...
      ?>
      <div class="image">
        <img src="<?php echo base_url('assets/upload/image/' . $user['gambar']);  ?>" class="img-circle elevation-2" alt="User Image">
      </div>
      <div class="info">
